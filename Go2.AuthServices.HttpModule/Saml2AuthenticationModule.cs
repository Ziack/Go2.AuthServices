...
namespace Go2.AuthServices.HttpModule
{
    ...
    public class Saml2AuthenticationModule : IHttpModule
    {
        ...
        /// 
        /// </summary>
        public Func<ISaml2AuthenticationContextWrapper> Saml2AuthenticationContextWrapperDelegate { get; set; }
        ...
        {
            Saml2AuthenticationContextWrapperDelegate = () => new Saml2AuthenticationContextWrapper();
        }
