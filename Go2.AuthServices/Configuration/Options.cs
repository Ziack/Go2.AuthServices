...
namespace Go2.AuthServices.Configuration
{
    ...
    public class Options : IOptions
    {
        ...
        /// events.
        /// </summary>
        public Go2AuthServicesNotifications Notifications { get; set; }
        ...
        {
            var spOptions = new SPOptions(Go2AuthServicesSection.Current);
            var options = new Options(spOptions);
            Go2AuthServicesSection.Current.IdentityProviders.RegisterIdentityProviders(options);
            Go2AuthServicesSection.Current.Federations.RegisterFederations(options);
        ...
        {
            Notifications = new Go2AuthServicesNotifications();
            SPOptions = spOptions;
        }
        ...
        /// <summary>
        /// Make Sha256 signature algorithm available in this process (not just Go2.AuthServices)
        /// </summary>
