...
namespace Go2.AuthServices.Configuration
{
    ...
    public class FederationCollection : ConfigurationElementCollection, IEnumerable<FederationElement>
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "Go2.AuthServices.Federation", Justification="The federation will register its identity providers in the options")]
