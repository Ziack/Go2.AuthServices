...
namespace Go2.AuthServices.Configuration
{
    ...
    /// </summary>
    public class Go2AuthServicesSection : ConfigurationSection
    {
        private static readonly Go2AuthServicesSection current =
            (Go2AuthServicesSection)ConfigurationManager.GetSection("Go2.AuthServices");
        ...
        /// </summary>
        public static Go2AuthServicesSection Current
        {
            get
            {
                return current;
