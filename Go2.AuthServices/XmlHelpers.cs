...
using System.Xml;
using System.Linq;
using Go2.AuthServices.Exceptions;
...
namespace Go2.AuthServices
{
    ...
    public static class XmlHelpers
    {
        ...
        private static void CheckSha256Support( SignedXml signedXml )
        {
            ...
            {
                throw new InvalidSignatureException("SHA256 signatures require the algorithm to be registered at the process level. Upgrade to .Net 4.6.2 or call Go2.AuthServices.Configuration.Options.GlobalEnableSha256XmlSignatures() on startup to register.");
            }
        }
